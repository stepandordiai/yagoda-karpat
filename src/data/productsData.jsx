	...
	const productsData = [
		{
			...
			name: t("products.bilberry") + " " + t("products.frozen1"),
			origin: "Україна",
			...
			variants: [
				{
					id: "bilberry-frozen",
					images: ["/products/bilberry/1-min.JPG"],
				},
			],
			isOrganic: true,
			harvest: [7, 8],
		},
		{
			...
			name: t("products.lingonberry") + " " + t("products.frozen1"),
			origin: "Україна",
			pack: "паперовий мішок 25 кг",
			...
			variants: [
				{
					...
					images: [
						"/products/lingonberry/1-min.jpg",
						"/products/lingonberry/2-min.jpg",
					],
				},
			],
			isOrganic: true,
		...
		},
		{
			...
			status: "frozen",
			latName: "Rosa canina",
			name: t("products.rosehip") + " " + t("products.frozen1"),
			origin: "Україна",
			pack: "паперовий мішок 25 кг",
			...
			variants: [
				{
					id: "rosehip-frozen",
					images: [
						"/products/rosehip/1-min.JPG",
						"/products/rosehip/2-min.JPG",
					],
				},
			],
			isOrganic: true,
		...
		},
		{
			...
			name: t("products.plum") + " " + t("products.frozen1"),
			origin: "Україна",
			...
			variants: [
				{
					...
					images: ["/products/plum/1-min.JPG"],
				},
				{
					id: "plum-frozen-half",
					state: t("product_page.state_6"),
					images: ["/products/plum-pitted/1-min.JPG"],
				},
			],
			harvest: [8, 9],
		},
		{
			...
			status: "dried",
			latName: "Prunus domestica",
			name: t("products.plum_dry") + " " + t("products.frozen1"),
			origin: "Україна",
			pack: "паперовий мішок 25 кг, картонна коробка 10 кг",
			...
			variants: [
				{
					...
					state: t("product_page.state_5"),
					images: [
						"/products/plum-dried/1-min.jpg",
						"/products/plum-dried/2-min.jpg",
						"/products/plum-dried/3-min.jpg",
					],
				},
			],
			harvest: [8, 9],
		...
		},
		{
			...
			name: t("products.elderberry") + " " + t("products.frozen1"),
			origin: "Україна",
			pack: "паперовий мішок 25 кг",
			...
			variants: [
				{
					...
					images: [
						"/products/elderberry/1-min.jpg",
						"/products/elderberry/2-min.jpg",
					],
				},
			],
			isOrganic: true,
		...
		},
		{
			...
			status: "frozen",
			latName: "Fragaria",
			name: t("products.strawberry") + " " + t("products.frozen1"),
			origin: "Україна",
			pack: "паперовий мішок 25 кг",
			...
			variants: [
				{
					...
					images: [
						"/products/strawberry/1-min.jpg",
						"/products/strawberry/2-min.jpg",
					],
				},
			],
			harvest: [5, 6, 7],
		},
		{
			...
			name: t("products.raspberry") + " " + t("products.frozen1"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
			...
			variants: [
				{
					id: "raspberry-frozen",
					images: [
						"/products/raspberry-frozen/1-min.JPG",
						"/products/raspberry-frozen/2-min.JPG",
					],
				},
			],
			harvest: [7, 8, 9],
		},
		{
			...
			name: t("products.apricot") + " " + t("products.frozen1"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
		...
		},
		{
			...
			name: t("products.sweet_pepper_red") + " " + t("products.frozen2"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
			...
			variants: [
				{
					...
					images: [
						"/products/sweet-pepper-red-frozen/1-min.JPG",
						"/products/sweet-pepper-red-frozen/2-min.JPG",
					],
				},
			],
			harvest: [7, 8, 9],
		},
		{
			...
			status: "frozen",
			latName: "Capsicum annuum",
			name: t("products.sweet_pepper_green") + " " + t("products.frozen2"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
			...
			variants: [
				{
					...
					state: t("product_page.state_4"),
					images: ["/products/sweet-pepper-green-frozen/1-min.JPG"],
				},
			],
			harvest: [7, 8, 9],
		},
		{
			...
			status: "frozen",
			latName: "Capsicum annuum",
			name: t("products.sweet_pepper_yellow") + " " + t("products.frozen2"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
			...
			variants: [
				{
					...
					images: ["/products/sweet-pepper-yellow-frozen/1-min.JPG"],
				},
			],
			harvest: [7, 8, 9],
		},
		{
			...
			status: "frozen",
			latName: "Capsicum annuum",
			name: t("products.sweet_pepper") + " " + t("products.frozen2"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
			desc: "Зібраний в момент повної зрілості, коли перець набуває своєї неперевершеної солодкості та яскравого кольору, він дарує справжній аромат сонячного тепла. Миттєва заморозка зберігає не лише смак, але й усю його природну користь, дозволяючи насолоджуватися свіжістю навіть у холодну пору року. Цей перець ідеально підходить для салатів, соусів, гарячих страв або запечених овочів. Його солодкий смак і соковитість додадуть кольору та глибини будь-якому рецепту, а легка хрустка текстура подарує відчуття свіжості та легкості.",
			variants: [
				{
					id: "sweet-pepper",
					images: [
						"/products/sweet-pepper-frozen/1-min.jpg",
						"/products/sweet-pepper-frozen/2-min.jpg",
					],
				},
			],
			harvest: [7, 8, 9],
		},
		{
			...
			name: t("products.boletus") + " " + t("products.frozen2"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
			...
			variants: [
				{
					...
					images: [
						"/products/boletus-frozen-whole/1-min.jpg",
						"/products/boletus-frozen-whole/2-min.jpg",
					],
				},
				{
					id: "boletus-frozen-slice",
					state: t("product_page.state_2"),
					images: ["/products/boletus-frozen-sliced/1-min.jpg"],
				},
				{
					id: "boletus-frozen-cubic",
					state: t("product_page.state_3"),
					images: [
						"/products/boletus-frozen-cubic/1-min.jpg",
						"/products/boletus-frozen-cubic/2-min.jpg",
					],
				},
			],
			harvest: [7, 8, 9],
		},
		{
			...
			status: "dried",
			latName: "Boletus edulis",
			name: t("products.boletus") + " " + t("products.dried2"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
			desc: "Зібраний в тіні старих дерев, білий гриб приносить з собою справжній лісовий аромат, що дарує відчуття спокою та гармонії з природою. Миттєва заморозка дозволяє зберегти його неповторний смак, а також всі корисні властивості, даруючи вам частинку дикої природи в будь-який час року. Цей гриб додає стравам глибину смаку, роблячи їх більш насиченими та ароматними. Від кремових супів і соусів до рагу та піци — білий гриб підкорює своєю елегантною текстурою та вишуканим смаком, що нагадує про літо, проведене в лісі, і спокій лісових прогулянок.",
			variants: [
				{
					id: "boletus-frozen-whole",
					images: ["/products/boletus-dried/1-min.jpg"],
				},
			],
			harvest: [7, 8, 9],
		},
		{
			...
			name: t("products.chanterelle") + " " + t("products.fresh2"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
			...
			variants: [
				{
					...
					images: ["/products/chanterelle/1-min.jpg"],
				},
			],
			harvest: [7, 8, 9],
		},
		{
			...
			status: "dried",
			latName: "Cantharellus cibarius",
			name: t("products.chanterelle") + " " + t("products.dried2"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
			desc: "Ці маленькі лісові скарби, зібрані вручну в чистих лісах, зберігають не лише свій характерний вигляд, а й особливий, ніжний смак, який додає стравам природної елегантності. Миттєва заморозка дозволяє зберегти їхню соковитість і легку, майже хрустку текстуру, а також усі корисні властивості, які дарує природа. Лисички — це гриби з характером. Вони вишукано поєднуються з кремовими соусами, пастою або м'ясними стравами, додаючи їм глибини та вишуканості. Їхній аромат оживляє будь-яку страву, перетворюючи прості рецепти на гастрономічні шедеври.",
			variants: [
		...
		},
		{
			...
			name: t("products.sour_cherry") + " " + t("products.frozen1"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
			...
			variants: [
				{
					...
					state: t("product_page.state_6"),
					images: [
						"/products/sour-cherry-frozen-pitted/1-min.jpg",
						"/products/sour-cherry-frozen-pitted/2-min.jpg",
						"/products/sour-cherry-frozen-pitted/3-min.jpg",
						"/products/sour-cherry-frozen-pitted/4-min.jpg",
						"/products/sour-cherry-frozen-pitted/5-min.JPG",
						"/products/sour-cherry-frozen-pitted/6-min.JPG",
					],
				},
				{
					...
					state: t("product_page.state_5"),
					images: [
						"/products/sour-cherry-frozen/1-min.jpg",
						"/products/sour-cherry-frozen/2-min.jpg",
					],
				},
			],
			harvest: [5, 6],
		},
		{
			...
			name: t("products.honey_fungus") + " " + t("products.frozen2"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
			...
			variants: [
				{
					...
					images: ["/products/honey-fungus/1-min.jpg"],
				},
			],
			harvest: [8, 9, 10],
		},
		{
			...
			name: t("products.blackberry") + " " + t("products.frozen1"),
			origin: "Україна",
		...
		},
		{
			...
			name: t("products.grape") + " " + t("products.frozen2"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
		...
		},
		{
			...
			status: "frozen",
			latName: "Zea mays",
			name: t("products.corn") + " " + t("products.frozen1"),
			origin: "Україна",
			pack: "картонна коробка 10 кг",
